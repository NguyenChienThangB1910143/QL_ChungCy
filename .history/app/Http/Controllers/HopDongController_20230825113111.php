...
class HopDongController extends Controller
{
    ...
    public function capnhat(Request $request)
    {
        ...
        $capnhathopdong = HopDongHopDong::join('users as user', 'user.id', '=', 'hopdong.id_user')
        ->join('users as ql', 'ql.id', '=', 'hopdong.id_ql')
        ->join('phong', 'phong.id_phong', '=', 'hopdong.id_phong')
        ->join('baixe', 'baixe.id_baixe', '=', 'hopdong.id_baixe')
        ->select(
        ...
        return view('hopdong/capnhat', compact('title', 'capnhathopdong', 'breadcrumbs','user', 'baixe', 'phong'));
    }
    public function update(Request $request)
    {
        ...
        $suahopdong = HopDong::where('id_hopdong', $request->id_hopdong)->update([
            ...
            'id_user' => $request->ten_user,
            'id_ql' => $request->ten_ql,
            'id_phong' => $request->ten_phong,
            'id_baixe' => $request->ms_baixe,
