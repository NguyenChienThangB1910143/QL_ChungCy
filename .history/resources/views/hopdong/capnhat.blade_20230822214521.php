    ...
    <div class="alert alert-primary">
        @foreach($capnhathopdong as $capnhat)
            ...
            <div class="mb-3">
                ...
                <input style="cursor: not-allowed;" name="id_user" class="form-control" value="{{$capnhat->id_user}}"></input>
            </div>
            <div class="mb-3">
                <label class="form-label">Tên Quản Lý</label>
                <input style="cursor: not-allowed;" name="id_ql" class="form-control" value="{{$capnhat->id_ql}}"></input>
            </div>
            <div class="mb-3">
                <label class="form-label">Mã phòng</label>
                <input style="cursor: not-allowed;" name="id_phong" class="form-control" value="{{$capnhat->id_phong}}"></input>
            </div>
            <div class="mb-3">
                <label class="form-label">Mã BX</label>
                <input style="cursor: not-allowed;" name="id_baixe" class="form-control" value="{{$capnhat->id_baixe}}"></input>
            </div>
