...
<div class="content-main">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="modal fade" id="edittang">
                ...
                <table class="table table-hover mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$tang->ten_toa}}</td>
                            <td>
                            <form action="{{route('tang-chinhsua', $tang->id_tang)}}" method="get">
                                    <button type="button" onclick=capnhat_tang('{{$tang->id_tang}}') class="btn btn-primary me-md-3">
    ...
    <script>
        ...
        function capnhat_tang(id_tang) {
            $.get('./tang/chinhsua/' + id_tang, function(data) {
                $("#body_edit").html(data);
            });
            $('#edittang').modal('show');
        }
        $('#body_edit').submit(function(evt) {
            ...
            var id_tang = $("#id_tang").val();
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: './tang/update/' + id_tang,
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
