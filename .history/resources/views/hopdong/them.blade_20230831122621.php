...
<script>
    ...
    document.querySelector('#tang').addEventListener('change', function() {
        let id_tang = this.value;
        let phongSelect = document.querySelector('#phong');
        phongSelect.innerHTML = '';
        for (const phong of phong) {
            if (phong.id_tang === id_tang && phong.tinhtrang === 0) {
