...
<div class="container col-md-auto mt-2">
    ...
    <input type="text" class="form-control" id="search" placeholder="Nhập id" list="userList">
...
<script>
    ...
    searchInput.addEventListener('input', function() {
        ...
        const filteredUsers = users.filter(function(user) {
            return user.id.toString().startsWith(searchValue);
        });

        // Cập nhật danh sách tùy chọn trong phần tử select
