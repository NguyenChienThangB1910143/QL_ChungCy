                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="{{route('hopdong-capnhat', $hopdong->id_hopdong)}}" method="get">
                                        <buton type="submit" onclick=chitiet_hopdong('{{$hopdong->id_hopdong}}') class="btn btn-info me-md-1 m-1">
                                            <i class="fas fa-eye"></i> 
                                        </buton>
                                        <button type="button" onclick=capnhat_hopdong('{{$hopdong->id_hopdong}}') class="btn btn-primary me-md-3">
