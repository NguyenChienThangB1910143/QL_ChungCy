@csrf
            <div class="container col-md-auto mt-2">
                <div class="alert alert-primary">
                    ...
                    @foreach($chitiethopdong as $chitiet)
                    <form method="post" action="{{route('hopdong-chitiet', $chitiet->id_hopdong)}}">
                        @csrf
                        <div class="row justify-content-center mb-2">
                            <div class="container">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <label name="id_hopdong" class="col-6 col-sm-6 text-view">{{$chitiet->id_hopdong}}</label>
                                </div>
                                <div class="row mb-1">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <label name="ten_ql" class="col-6 col-sm-6 text-view">{{$chitiet->ten_ql}}</label>
                                </div>
                                <div class="row mb-1">
                                    <div style="cursor: default;" class="col-6 col-sm-6">Phòng:</div>
                                    <label name="ten_phong" class="col-6 col-sm-6 text-view">{{$chitiet->ten_phong}}</label>
                                </div>
                                ...
                                <div class="row mb-1">
                                    ...
                                    <label name="ngayketthuc" class="col-6 col-sm-6 text-view">{{$chitiet->ngayketthuc}}</label>
                                </div>
                            </div>
                        </div>
                    </form>
