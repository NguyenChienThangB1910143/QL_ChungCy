...
<div class="container col-md-auto mt-2">
    <div class="alert alert-primary">
        ...
        <p>Tên của user được chọn: <span id="userName"></span></p>
        <div class="mb-3 option-user">
...
var input = document.querySelector('#search');
    ...
    input.addEventListener('input', function() {
        // Lấy giá trị của input (id của user được chọn)
        var userId = this.value;

        // Truy vấn dữ liệu từ cơ sở dữ liệu để lấy thông tin của user có id tương ứng
        // (thay thế đoạn code này bằng code thực tế để truy vấn dữ liệu từ cơ sở dữ liệu)
        var user = {
            id: userId,
            name: 'Tên của user có id ' + userId
        };

        // Cập nhật nội dung cho phần tử span
